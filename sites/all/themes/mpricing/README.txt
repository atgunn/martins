...
http://drupal.org/project/mpricing
...
To fully convert Framework to your own custom theme, it is encouraged that you: 
 - COPY the 'mpricing' directory within sites/all/themes/ and rename it as 'yourthemename' 
 - Change the filename and contents of the .info file accordingly and remove all 'packing script' info at the end of the file
 - Use find/replace in template.php to replace 'mpricing' with 'yourthemename' 
...
http://drupal.org/project/issues/mpricing
